...
public class ClientMessage {
    //프로토콜 번호
    final static int PROTOCOL_LOGIN_RESPONSE = 1000;
    final static int PROTOCOL_LOGIN_SUC = 3010;
    final static int PROTOCOL_LOGIN_FAIL = 3020;

    //관리자 프로토콜
    final static int PROTOCOL_ADMIN_INSERT_PRO_ID_EXIST = 12011;
    final static int PROTOCOL_ADMIN_INSERT_PRO = 12012;
    final static int PROTOCOL_ADMIN_INSERT_SUC = 12013;
    final static int PROTOCOL_ADMIN_INSERT_FAIL = 12014;

    final static int PROTOCOL_ADMIN_INSERT_STU_ID_EXIST = 12021;
    final static int PROTOCOL_ADMIN_INSERT_STU = 12022;
    final static int PROTOCOL_ADMIN_INSERT_STU_SUC = 12023;
    final static int PROTOCOL_ADMIN_INSERT_STU_FAIL = 12024;

    final static int PROTOCOL_ADMIN_INSERT_NOT_OPEN_SUB_ID_EXIST = 12031;
    final static int PROTOCOL_ADMIN_INSERT_NOT_OPEN_SUB = 12032;
    final static int PROTOCOL_ADMIN_INSERT_NOT_OPEN_SUB_SUC = 12033;
    final static int PROTOCOL_ADMIN_INSERT_NOT_OPEN_SUB_FAIL = 12034;

    final static int PROTOCOL_ADMIN_UPDT_NOT_OPEN_SUB = 12041;
    final static int PROTOCOL_ADMIN_UPDT_NOT_OPEN_SUB_NOT_EXIST = 12042;
    final static int PROTOCOL_ADMIN_UPDT_NOT_OPEN_SUB_SUC = 12043;
    final static int PROTOCOL_ADMIN_UPDT_NOT_OPEN_SUB_FAIL = 12044;

    final static int PROTOCOL_ADMIN_DEL_NOT_OPEN_SUB_SUC = 12051;
    final static int PROTOCOL_ADMIN_DEL_NOT_OPEN_SUB_FAIL = 12052;

    final static int PROTOCOL_ADMIN_UPDATE_PLAN_MODIFY_DATE = 12061;
    final static int PROTOCOL_ADMIN_UPDATE_PLAN_MODIFY_DATE_ID_NOT_EXIST = 12062;
    final static int PROTOCOL_ADMIN_UPDATE_PLAN_MODIFY_DATE_SUC = 12063;
    final static int PROTOCOL_ADMIN_UPDATE_PLAN_MODIFY_DATE_FAIL = 12064;

    final static int PROTOCOL_ADMIN_UPDATE_ENROLL_TERM_SUC = 12071;
    final static int PROTOCOL_ADMIN_UPDATE_ENROLL_TERM_FAIL = 12072;

    final static int PROTOCOL_ADMIN_SELECT_PRO_ALL = 12080;

    final static int PROTOCOL_ADMIN_SELECT_STU_ALL = 12090;

    final static int PROTOCOL_ADMIN_SELECT_OPEN_SUB_ALL = 12100;

    final static int PROTOCOL_ADMIN_INSERT_OPEN_SUB = 12111;
    final static int PROTOCOL_ADMIN_INSERT_OPEN_SUB_ID_NOT_EXIST = 12112;
    final static int PROTOCOL_ADMIN_INSERT_OPEN_SUB_SUC = 12113;
    final static int PROTOCOL_ADMIN_INSERT_OPEN_SUB_FAIL = 12114;

    final static int PROTOCOL_ADMIN_UPDATE_OPEN_SUB = 12121;
    final static int PROTOCOL_ADMIN_UPDATE_OPEN_SUB_ID_NOT_EXIST = 12122;
    final static int PROTOCOL_ADMIN_UPDATE_OPEN_SUB_SUC = 12123;
    final static int PROTOCOL_ADMIN_UPDATE_OPEN_SUB_FAIL = 12124;

    final static int PROTOCOL_ADMIN_DEL_OPEN_SUB_SUC = 12131;
    final static int PROTOCOL_ADMIN_DEL_OPEN_SUB_FAIL = 12132;

    final static int PROTOCOL_PROFESSOR_UPDATE_INFO_SUC = 22011;
    final static int PROTOCOL_PROFESSOR_UPDATE_INFO_FAIL = 22012;

    //교수 프로토콜
    final static int PROTOCOL_PROFESSOR_INSERT_ID_EXIST = 22021;
    final static int PROTOCOL_PROFESSOR_INSERT = 22022;
    final static int PROTOCOL_PROFESSOR_INSERT_SUC = 22023;
    final static int PROTOCOL_PROFESSOR_INSERT_FAIL = 22024;

    final static int PROTOCOL_PROFESSOR_SUBJECT_PLAN_UPDATE_ID_EXIST = 22031;
    final static int PROTOCOL_PROFESSOR_SUBJECT_PLAN_UPDATE = 22032;
    final static int PROTOCOL_PROFESSOR_SUBJECT_PLAN_UPDATE_SUC = 22033;
    final static int PROTOCOL_PROFESSOR_SUBJECT_PLAN_UPDATE_FAIL = 22034;

    final static int PROTOCOL_PROFESSOR_SUBJECT_LIST = 22040;

    final static int PROTOCOL_PROFESSOR_SUBJECT_PLAN_LIST = 22050;

    final static int PROTOCOL_PROFESSOR_ENROLL_STUDENT = 22060;

    final static int PROTOCOL_PROFESSOR_SUBJECT_ID_NOT_EXIST = 22062;

    final static int PROTOCOL_PROFESSOR_SUBJECT_TIMETABLE = 22070;

    //학생 프로토콜
    final static int PROTOCOL_STUDENT_UPDATE_INFO_SUC = 32011;
    final static int PROTOCOL_STUDENT_UPDATE_INFO_FAIL = 32012;

    final static int PROTOCOL_STUDENT_ENROLL_SUC = 32021;
    final static int PROTOCOL_STUDENT_ENROLL_FAIL = 32022;

    final static int PROTOCOL_STUDENT_ENROLL_CANCEL_SUC = 32031;
    final static int PROTOCOL_STUDENT_ENROLL_CANCEL_FAIL = 32032;

    final static int PROTOCOL_STUDENT_OPEN_SUBJECT_LIST = 32040;

    final static int PROTOCOL_STUDENT_SELECT_SUBJECT_PLAN_LIST = 32051;
    final static int PROTOCOL_STUDENT_SELECT_SUBJECT_PLAN_FAIL = 32052;

    final static int PROTOCOL_STUDENT_MY_TIMETABLE = 32060;

    //메뉴
    final static String MENU_INPUT = "번호 : ";
    final static int INPUT_COMMAND_1 = 1;
    final static int INPUT_COMMAND_2 = 2;
    final static int INPUT_COMMAND_3 = 3;
    final static int INPUT_COMMAND_4 = 4;
    final static int INPUT_COMMAND_5 = 5;
    final static int INPUT_COMMAND_6 = 6;
    final static int INPUT_COMMAND_7 = 7;
    final static int INPUT_COMMAND_8 = 8;
    final static int INPUT_COMMAND_9 = 9;
    final static int INPUT_COMMAND_10 = 10;
    final static int INPUT_COMMAND_11 = 11;
    final static int INPUT_COMMAND_12 = 12;
    final static int INPUT_COMMAND_13 = 13;
    final static int INPUT_COMMAND_14 = 14;
