...
public class EnrollServer implements Runnable {
    ...
    static int[] userIdList = new int[20];
    ...
    public int readHeader(byte[] receivePacket){
    ...
    public void adminMenu() {
        ...
        try {
            ...
            while (true) {
                ...
                switch (headerReader) {
                    case ServerMessage.PROTOCOL_ADMIN_CRT_PRO_REQUEST_ID:
                        isExist = true;
                    ...
                    case ServerMessage.PROTOCOL_ADMIN_CRT_STU_REQUEST_ID:
                        isExist = true;
                    ...
                    case ServerMessage.PROTOCOL_ADMIN_CRT_NOT_OPEN_SUBJECT_REQUEST_ID:
                        isExist = true;
                        ...
                        if(isExist){
                            protocol.getAdminResponsePacket(Message.FUNCTION_TYPE_MAKE_SUBJECT, Message.CODE_TYPE_2);
                        }else{
                            protocol.getAdminResponsePacket(Message.FUNCTION_TYPE_MAKE_SUBJECT, Message.CODE_TYPE_1);
                        }
                        dos.write(protocol.getPacket(), 0, protocol.getSize()); // 프로토콜 전송
                        dos.flush();
                        break;
                    case ServerMessage.PROTOCOL_ADMIN_CRT_SUBJECT_REQUEST_INFO:
                        dis.read(receiveHeader);   // name 읽어옴
                        ...
                        try{
                            ...
                            protocol.getAdminResponsePacket(Message.FUNCTION_TYPE_MAKE_SUBJECT, Message.CODE_TYPE_3);
                        }catch (Exception e){
                            protocol.getAdminResponsePacket(Message.FUNCTION_TYPE_MAKE_SUBJECT, Message.CODE_TYPE_4);
                        } finally {
                            id = 0;
                            dos.write(protocol.getPacket(), 0, protocol.getSize()); // 프로토콜 전송
                            dos.flush();
                    ...
                    case ServerMessage.PROTOCOL_ADMIN_UPDT_NOT_OPEN_SUBJECT_REQUEST_ID:
                        ...
                        if(isExist){
                            protocol.getAdminResponsePacket(Message.FUNCTION_TYPE_UPDATE_SUBJECT, Message.CODE_TYPE_1);
                        }else{
                            protocol.getAdminResponsePacket(Message.FUNCTION_TYPE_UPDATE_SUBJECT, Message.CODE_TYPE_2);
                        }
                        dos.write(protocol.getPacket(), 0, protocol.getSize()); // 프로토콜 전송
                        dos.flush();
                        break;
                    case ServerMessage.PROTOCOL_ADMIN_UPDT_NOT_OPEN_SUBJECT_REQUEST_NAME:
                        dis.read(receiveHeader);
                        subject_name = changeByteToString(receiveHeader);

                        try{
                            subjectNotOpenService.updateSubjectNotOpen(id,subject_name, subject_grade);
                            protocol.getAdminResponsePacket(Message.FUNCTION_TYPE_UPDATE_SUBJECT, Message.CODE_TYPE_3);
                            System.out.println("------------------------------");
                            System.out.println(readHeader(protocol.getPacket()));
                            System.out.println("------------------------------");
                        }catch (Exception e){
                            protocol.getAdminResponsePacket(Message.FUNCTION_TYPE_UPDATE_SUBJECT, Message.CODE_TYPE_4);
                        }finally {
                            System.out.println("------------------------------");
                            System.out.println(readHeader(protocol.getPacket()));
                            System.out.println("------------------------------");
                    ...
                    case ServerMessage.PROTOCOL_ADMIN_UPDT_NOT_OPEN_SUBJECT_REQUEST_GRADE:
                        dis.read(receiveHeader);
                        subject_grade = changeByteToInt(receiveHeader);
                    ...
                    case ServerMessage.PROTOCOL_ADMIN_DEL_NOT_OPEN_SUBJECT_REQUEST_ID:
                        isExist = false;
                        ...
                        if(isExist){
                            ...
                            protocol.getAdminResponsePacket(Message.FUNCTION_TYPE_DELETE_SUBJECT, Message.CODE_TYPE_1);
                        }else{
                            protocol.getAdminResponsePacket(Message.FUNCTION_TYPE_DELETE_SUBJECT, Message.CODE_TYPE_2);
                        }
                        dos.write(protocol.getPacket(), 0, protocol.getSize()); // 프로토콜 전송
                        dos.flush();
                        break;
                    case ServerMessage.PROTOCOL_ADMIN_UPDT_SUBJECT_PLAN_REQUEST_ID:
                        isExist = true;
                        ...
                        dos.flush();
                        break;
                    case ServerMessage.PROTOCOL_ADMIN_UPDT_SUBJECT_PLAN_REQUEST_DATE:
                    ...
                    case ServerMessage.PROTOCOL_ADMIN_UPDT_EROLL_DATE_PER_GRADE:
                        dis.read(receiveHeader);
                    ...
                    case ServerMessage.PROTOCOL_ADMIN_SELECT_PRO_REQUEST:
                        professorDTOList = professorService.findProfessorAll();
                        int listSize = professorDTOList.size();
                        protocol.setAdminResponseListPacket(Message.FUNCTION_TYPE_FIND_PROFESSOR, listSize);
                        ...
                        dos.flush();
                        break;
                    case ServerMessage.PROTOCOL_ADMIN_SELECT_STU_REQUEST:
                        studentDTOS = studentService.findStudentAll();
                        listSize = studentDTOS.size();
                        protocol.setAdminResponseListPacket(Message.FUNCTION_TYPE_FIND_STUDENT, listSize);
                        ...
                        dos.flush();
                        break;
                    case ServerMessage.PROTOCOL_ADMIN_SELECT_OPEN_SUBJECT_REQUEST:
                        ...
                        dos.flush();
                        break;
                    case ServerMessage.PROTOCOL_ADMIN_CRT_OPEN_SUBJECT_REQUEST_ID:
                        isExist = false;
    ...
    public void professorMenu(){
        ...
        try {
            ...
            while(true){
                ...
                switch (headerReader) {
                    // 개인정보 수정
                    case ServerMessage.PROTOCOL_PRO_UPDT_INFO_REQUEST_PW:
                        dis.read(receiveHeader);
                        pw = changeByteToString(receiveHeader);
                    ...
                    case ServerMessage.PROTOCOL_PRO_UPDT_INFO_REQUEST_NAME:
                        dis.read(receiveHeader);
                    ...
                    case ServerMessage.PROTOCOL_PRO_UPDT_INFO_REQUEST_BIRTH:
                        dis.read(receiveHeader);
                        birth = changeByteToString(receiveHeader);
                    ...
                    case ServerMessage.PROTOCOL_PRO_UPDT_INFO_REQUEST_PHONENUMBER:
                        dis.read(receiveHeader);
                        phoneNum = changeByteToString(receiveHeader);
                    ...
                    case ServerMessage.PROTOCOL_PRO_UPDT_INFO_REQUEST_MAJOR:
                        dis.read(receiveHeader);
                        major = changeByteToString(receiveHeader);
    ...
    public void studentMenu(){
        ...
        try {
            ...
            List<StudentDTO> all = studentService.findStudentAll();
            ...
            while(true){
                ...
                switch (headerReader) {
                    // 개인정보 수정
                    case ServerMessage.PROTOCOL_STU_UPDT_INFO_REQUEST_PW:
                        dis.read(receiveHeader);
                        pw = changeByteToString(receiveHeader);
                        studentDTO.setPw(pw);
                        try{
                    ...
                    case ServerMessage.PROTOCOL_STU_UPDT_INFO_REQUEST_NAME:
                        dis.read(receiveHeader);
                        name = changeByteToString(receiveHeader);
                    ...
                    case ServerMessage.PROTOCOL_STU_UPDT_INFO_REQUEST_BIRTH:
                        dis.read(receiveHeader);
                        birth = changeByteToString(receiveHeader);
                    ...
                    case ServerMessage.PROTOCOL_STU_UPDT_INFO_REQUEST_PHONENUMBER:
                        dis.read(receiveHeader);
                        phoneNum = changeByteToString(receiveHeader);
                    ...
                    case ServerMessage.PROTOCOL_STU_UPDT_INFO_REQUEST_MAJOR:
                        dis.read(receiveHeader);
                        major = changeByteToString(receiveHeader);
                    ...
                    case ServerMessage.PROTOCOL_STU_UPDT_INFO_REQUEST_GRADE:
                        dis.read(receiveHeader);
